...
#input1 = cv2.imread('MultiView/MOVI_ToyHouse1/im002_1.png')  #queryimage # left image
#input2 = cv2.imread('MultiView/MOVI_ToyHouse1/im003_1.png')  #queryimage # left image
